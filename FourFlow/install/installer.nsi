...
Section "Start Menu Shortcuts"
  ...
  CreateShortCut "$SMPROGRAMS\FourFlow\ParaView Users Guide v3.14.lnk" "$INSTDIR\ParaViewManual.v3.98.pdf" "" "$INSTDIR\ParaViewManual.v3.98.pdf" 0
